            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mx-2 md:mx-5">
                ...
                <div className="bg-[#027afb17] p-4 rounded-lg">
                    ...
                    <p className="text-lg">
                        ...
                        জন্য একটি মনোরম পরিবেশ তৈরি করেছে।{" "}
                        <span className="hidden md:inline">
                            স্কুলটির লক্ষ্য শুধু পরীক্ষার ফলাফল নয়, বরং নৈতিক
                            মূল্যবোধ ও চরিত্র গঠনের মাধ্যমে শিক্ষার্থীদের একটি
                            সুন্দর ভবিষ্যৎ উপহার দেওয়া। স্কুলের শিক্ষকগণ
                            পরিশ্রমী ও নিবেদিতপ্রাণ। শিক্ষার্থীদের মানসিক,
                            শারীরিক ও সাংস্কৃতিক উন্নতির জন্য স্কুলে বিভিন্ন
